    ...
    // this.$nextTick(function() {
      this.create({
        ...
        onSuccess: () => {
          this.$message({
            duration:5000,
            message: this.$selfMsg.imgVaildSucess,
            type: "success"
          });
        ...
        onFail: () => {
          this.$message({
            duration:5000,
            message: this.$selfMsg.imgVaildError,
            type: "error"
          });
          if(this.vaildImgCheck){
          this.vaildImgCheck()
  ...
  methods: {
    create(opts) {
      ...
      function getRandomImg() {
        let src=require('@/assets/JigsawPuzzle/'+getRandomNumberByRange(1, 25)+'.png')
        // return (
        //   "https://picsum.photos/300/150/?image=" +
        //   getRandomNumberByRange(1, 26)
        // );
        return src
      }
...
.sliderMask {
  ...
  border: 0 solid rgba(196, 165, 127, 1);
  // background: #d1e9fe;
