<template>
  <section class="homePage">
    <!-- 轮播图 -->
    <!-- <el-carousel class="app-change-autoPic app-clear" :autoplay="autoFlag"> -->
    <!-- <el-carousel-item v-for="(item) in picAry" :key="item.id"> -->
    <!-- <div
          :style="{backgroundImage:'url('+item.pictureUri+')'}"
          :class="[picFlagAry[index]?'autoPic':'','app-homePage-autoImg']"
    >-->
    <!-- <a :href="item.pictureJumpUrl" target="view_window" style="width:100%;display:block">
          <img class="thumbImg" v-lazy="item.pictureUri" alt>
    </a>-->
    <!-- </div> -->
    <!-- </el-carousel-item> -->
    <!-- </el-carousel> -->
    <div v-swiper:mySwiper="swiperOption" class="app-change-swiper" v-if="picAry.length>0" @mouseover="hideFlag=true" @mouseleave="hideFlag=false" >
    ...
    <el-main style="margin-top:0;width:1366px;margin:0 auto;" class="app-home-page">
      ...
      <ul class="home_icon">
        <li @click="jump('1')">
          <img v-lazy="require('@/assets/img/图层 78@2x.png')" alt>
          <span style="color:#087276">上课</span>
        </li>
        <li @click="jump('2')">
          <img v-lazy="require('@/assets/img/图层 79@2x.png')" alt>
        ...
        <li @click="jump('3')">
          <!-- <img
            ...
            alt=""
          >-->
          <img v-lazy="require('@/assets/img/图层 81@2x.png')" alt>
    ...
    >
          ...
          <div class="HealthClass">
            ...
            >
              <el-carousel-item v-for="item in 4" :key="item">
                <div class="autoPic">
                  <img v-lazy="require('@/assets/img/Health_class1.png')" alt>
      ...
      <div class="app-change-index-box">
        <div class="ClassroomAndTeache">
          <h1 class="les">
            教室与老师
            <p class="app-index-Subheading">这是一件关于美的教室</p>
          </h1>
          <div class="Image">
            <ul>
              <li>
                <a href="about">
                  ...
                  <dl>
                    <dt>暄桐教室</dt>
                    <dd style="padding:0 34px">暄桐是一间书法教室，旨在以书法为起点，亲近中国传统之美</dd>
                  </dl>
                </a>
              </li>
              <li>
                <a href="about">
                  ...
                  <dl>
                    <dt>林曦</dt>
                    <dd style="padding:0 34px">水墨画家，1983年生于重庆，暄桐教室的创办人与授课老师</dd>
                  </dl>
                </a>
              </li>
              <li>
                <a href="about">
                  ...
                  <dl>
                    <dt>暄桐线上课</dt>
                    <dd style="padding:0 34px">线上直播课程是专门为零基础的成年人而精心设计的教学系统</dd>
                  </dl>
                </a>
              </li>
            </ul>
      ...
      <div class="app-change-index-box">
        <div class="ClassmateWorks">
          <h1 class="les" style="width:1000px;margin:0 auto;">
            同学作品
            <p class="app-index-Subheading">从一个字到一件书法作品</p>
          </h1>
          <div class="tabworks">
          ...
          >
            <el-carousel-item v-for="item in ClassmateWorksImg" :key="item.productionId">
              <img alt v-lazy="item.thumbUrl">
            </el-carousel-item>
            </el-carousel>-->
          </div>
          <p class="lookAll les" style="margin:0 auto;margin-top:40px;width:1000px;">
...
export default {
  ...
  mounted() {
    // this.$axios.post('/WxLogin/wxlogin').then(res=>{
    //   console.log('wx',res)
    // })
    this.backPos();
