      ...
      <div class="Learning_body flex" style="min-height:800px">
        ...
        <div class="Learning_rightContent">
          <div class="Learning_rightContent-Title">
            <h3 class="fz16 c0 dis_in_block" style="font-weight:400">交作业</h3>
            <span class="fz14 c4a5 fr" @click="goBack()" style="cursor:pointer">&#60;&#60; 返回"去上课"</span>
          </div>
          <!--晒作业-->
          <div class="Bask_homework app-Bask_homework">
            <p class="fz14 c30" style="color:rgba(0,0,0,.7)">说说你的作业感想吧</p>
            <div class="mt-24 app-change-richText-mt50 app-change-write-richText " style="margin-top:13px">
              ...
              <div class="mt-15 app-change-write-label " style="margin-top:11px;position:relative">
                <input type="button" class="fr btn-Bask_homework outline" value="提交" @click="Submit">
                <span class="fz12 cb49 fr app-change-checkBox">
                  <el-checkbox
                    v-model="checked"
            ...
            <!-- 往期作业 -->
            <div class="Past_work">
              <h3 class="fz16 c30" style="font-weight:400">你已提交过:</h3>
              <ul class="Homework-ulList app-Homework-ulList" v-if="oldlist.length>0">
                <li v-for="(item) in oldlist" :key="item.homeworkFinishId" style="padding-top:10px" >
                  <div style="width:100%">
                    <time class="fz14 c30">
                      <!-- <i class="el-icon-date cb19 fz16"></i> 弃用-->
                    ...
                    <span
                      ...
                      <!-- <img :src="require('@/assets/img/yesTrue.png')" alt="" style="width:16px"> 弃用 -->
                      已晒出
                    </span>
                    <!-- <span
                      class="cb19 fz16"
                    ...
                    <div style="margin-top:11px">
                      ...
                      <span
                        class="fz14"
                        v-html="item.content"
                        style="display:block;width:321px;color:rgba(0,0,0,.8)"
                      ></span>
                      <div class="pos_r">
                        <ul>
                    ...
                    <div class="teacherEvaluation">
                      <ul>
                        <li
                          ...
                          :key="indexs"
                        >
                          <h4 class="fz14 cb49" style="font-weight:400">助教老师说：</h4>
                          <p
                            class="fz14 c30"
                          ...
                          <div class="pos_r" v-if="items.picList.length>0">
                            <ul>
                          ...
                          >{{items.userNickName+'助教'}} {{initTime(items.createTime)}}</time>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="course_no_data" v-if="oldlist.length<=0" style="text-align:center">
                ...
                <p class="fz12 c4a5 mt-15">等待你的作业哦</p>
              </div>
            </div>
          </div>
        </div>
    ...
    Submit() {
      ...
      this.$axios
        .post("/userhomework/add", {
          ...
          homeworkTypeId: this.detail.homeworkType, //作业类型id
...
<style lang="less">
// .app-change-write-richText{
//   .richEdit.w-e-text-container{
